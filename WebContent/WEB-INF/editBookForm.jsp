						...
						<div class="col-lg-6">
							<div>
								<form class="form-horizontal"
									action="./EditBookServlet" method="post">
									<fieldset>


												<legend>変更する図書の情報を記入してください。</legend>
												<div class="form-group">
													<input type="hidden" name="book_id" value="${registerBook.bookId}">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="location.href='registrationCompletion.jsp'">登録</button>
									...
									<div class="form-group">
										<div class="col-lg-10 col-lg-offset-8">
											...
											<% if(registerBook.getRentalStatus()){}else{ %>
											<button type="reset" class="btn btn-default" onclick="location.href='EditBookServlet?action=delete'">削除</button>
											<%} %>
